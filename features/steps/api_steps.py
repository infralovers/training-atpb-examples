...
def step_impl(context, string):
    context.global_res = requests.post("http://localhost:5000/api/article", json={"title": string, "content": "My article text"})
...
def step_impl(context,string):
   assert string in context.global_res.request.content
